...
function initMusic(){
    ...
    if(!musicOn){
        musicTrack = new Audio('assets/music/sinnesloschen-beam-117362.mp3');
...
// scatterAssets(65);
// scatterBoxes(15);
addTarget(40 ,40, "tie", 12, true, "fly-right", 1, 4567);

addTarget(60 ,40, "tie_flip", 9, true, "fly-left", 1,3457);

addTarget(20 ,31, "tie_flip", 7, true, "fly-left", 1,5678);

addTarget(70 ,20, "tie", 6, true, "fly-right", 1, 2345);

addTarget(20 ,70, "tie_flip", 15, true, "fly-left", 1, 4344);
