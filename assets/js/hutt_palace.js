...
//front area
addProp(20, 75, "chest", 8 , true);
addProp(45, 79, "chest", 9 , true);
addProp(55, 79, "chest", 9 , true);
addTarget(20, 74, "ewok", 6, true, "jumping", 0, 1111);
addTarget(16, 78, "ewok", 7, true, "jumping", 0, 1344);

addTarget(45, 78, "ewok", 7, true, "evading", 0, 1120);
addTarget(52, 76, "ewok", 7, true, "evading", 0, 896);
addTarget(65, 76, "ewok", 6, true, "evading", 0, 1322);
//mid area

addProp(60, 51, "barrel", 5 , true);
addTarget(59, 53, "ewok", 4, true, "dancing", 50, 896);


addTarget(60, 62, "ewok", 6, true, "vibrating",);

//back area 
addProp(45, 60, "fancy_chair", 8, false);
addTarget(47, 60, "ewok", 6, true, "jumping", 0, 1356);

addProp(25, 60, "fancy_chair", 8, false);
addTarget(27, 60, "ewok", 6, true, "jumping", 0, 1156);

addProp(28, 51, "fancy_chair", 5, false);
addProp(34, 60, "chest", 6 , true);
