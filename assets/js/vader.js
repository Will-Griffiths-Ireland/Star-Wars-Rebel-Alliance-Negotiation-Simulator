...
function addBackground(){
    ...
    bg.src = "./assets/backgrounds/bg-dark.webp";
...
function addTarget(relX, relY, type, scale, destructable, motionType, zIndex){
    ...
    asset.setAttribute('data-vader-health', 5)
    
    if(destructable){
        asset.addEventListener("click", destroyTarget, false);
    }
...
function destroyTarget(e){
    ...
    currentHealth = Number(e.currentTarget.getAttribute("data-vader-health")) - 1
    e.currentTarget.setAttribute('data-vader-health', currentHealth)
...
// scatterAssets(65);
// scatterBoxes(15);
addTarget(40 ,40, "vader", 12, true, "scaling", 1);